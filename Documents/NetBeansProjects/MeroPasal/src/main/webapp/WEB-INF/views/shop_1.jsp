<%-- 
    Document   : shop
    Created on : Jan 6, 2020, 3:11:52 PM
    Author     : ROSHAB
--%>
				...
				<ul class="header-cart-wrapitem w-full">
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="${pageContext.request.contextPath}/static/images/item-cart-01.jpg" alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="${pageContext.request.contextPath}/static/images/item-cart-02.jpg" alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="${pageContext.request.contextPath}/static/images/item-cart-03.jpg" alt="IMG">
						</div>
		...
		<div class="container">
			...
			<div class="row isotope-grid">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="${pageContext.request.contextPath}/static/images/product-01.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="${pageContext.request.contextPath}/static/images/product-02.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="${pageContext.request.contextPath}/static/images/product-03.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="${pageContext.request.contextPath}/static/images/product-04.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="${pageContext.request.contextPath}/static/images/product-05.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item watches">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="${pageContext.request.contextPath}/static/images/product-06.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="${pageContext.request.contextPath}/static/images/product-07.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="${pageContext.request.contextPath}/static/images/product-08.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item shoes">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="${pageContext.request.contextPath}/static/images/product-09.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="${pageContext.request.contextPath}/static/images/product-10.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="${pageContext.request.contextPath}/static/images/product-11.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="${pageContext.request.contextPath}/static/images/product-12.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="${pageContext.request.contextPath}/static/images/product-13.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="${pageContext.request.contextPath}/static/images/product-14.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item watches">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="${pageContext.request.contextPath}/static/images/product-15.jpg" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="${pageContext.request.contextPath}/static/images/product-16.jpg" alt="IMG-PRODUCT">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="images/product-detail-01.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="${pageContext.request.contextPath}/static/images/product-detail-01.jpg" alt="IMG-PRODUCT">
									...
									<div class="item-slick3" data-thumb="images/product-detail-02.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="${pageContext.request.contextPath}/static/images/product-detail-02.jpg" alt="IMG-PRODUCT">
									...
									<div class="item-slick3" data-thumb="images/product-detail-03.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="${pageContext.request.contextPath}/static/images/product-detail-03.jpg" alt="IMG-PRODUCT">
