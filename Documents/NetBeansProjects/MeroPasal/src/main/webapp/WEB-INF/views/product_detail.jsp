<%-- 
    ...
    Created on : Dec 27, 2019, 11:59:10 AM
    Author     : ROSHAB
--%>
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="${pageContext.request.contextPath}/product_image/${prod.image}">
									<div class="wrap-pic-w pos-relative">
                                                                            <img src="${pageContext.request.contextPath}/product_image/${prod.image}" alt="${product.name}" >
<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="${pageContext.request.contextPath}/product_image/${prod.image}">
									...
									<div class="wrap-num-product flex-w m-r-20 m-tb-10">
										...
										<div class="btn-num-product-up cl8 hov-btn3 trans-04 flex-c-m">
											<i class="fs-16 zmdi zmdi-plus"></i>
                                                                    ...
                                                                    <input type="submit" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04"  value="Add to cart" >
