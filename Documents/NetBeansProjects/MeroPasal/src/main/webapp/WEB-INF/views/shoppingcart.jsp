<%-- 
    ...
    Created on : Dec 31, 2019, 10:31:52 AM
    Author     : ROSHAB
--%>
						...
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								...
								<tr class="table_row">
									<td class="column-1">
										<div class="how-itemcart1">
											<img src="${pageContext.request.contextPath}/static/images/item-cart-04.jpg" alt="IMG">
										</div>
									</td>
								...
								<tr class="table_row">
									<td class="column-1">
										<div class="how-itemcart1">
											<img src="${pageContext.request.contextPath}/static/images/item-cart-05.jpg" alt="IMG">
										</div>
									</td>
